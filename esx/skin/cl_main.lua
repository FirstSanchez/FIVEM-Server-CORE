...
CreateThread(function()
    while true do
        ...
        if isCameraActive then
            ...
            ESX.ShowHelpNotification('Benutze NUMPAD4 und NUMPAD6 um die Sicht zu drehen.')
            -- exports['diaz-system']:ShowHelpNotify("Benutze NUMPAD4 und NUMPAD6 zum drehen.", "E")
        end
        Wait(sleep)
    end
end)
...
RegisterNetEvent('dnz_ev3:skinLoaded')
AddEventHandler('dnz_ev3:skinLoaded', function()
    ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
        if skin == nil then
            TriggerEvent('skinchanger:loadSkin', {sex = 0}, OpenSaveableMenu)
        else
