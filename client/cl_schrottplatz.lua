...
CreateThread(function()
    ...
    if ishim then
        TriggerEvent('cataleya_hud:sendNotify', "success", "HotLife | Schrottplatz", "Du hast dein Fahrzeug endgültig verschrottet!", 5500)
        DeleteVehicle(vehicle)
    else 
        TriggerEvent('cataleya_hud:sendNotify', "error", "HotLife | Schrottplatz", "Das ist nicht dein Fahrzeug!", 5500)
    end
    end, vehicleProps)
end
end
