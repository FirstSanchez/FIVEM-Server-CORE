Locales ['en'] = {
    ...
    ['vehicleshop_bought'] = 'Du hast dir einen %s für ~g~€%s gekauft!',
    ['vehicleshop_money'] = 'Du kannst dir dieses Fahrzeug nicht leisten!',
    ['vehicleshop_awaiting_model'] = 'Dieses Fahrzeug ~g~LÄDT bitte warte',
    ['confirm_no'] = 'Nein',
    ['confirm_yes'] = 'Ja',
    ['revive_inprogress'] = 'Eine Wiederbelebung findet statt!',
    ['revive_complete'] = 'Du hast %s wiederbelebt',
    ['revive_complete_award'] = 'Du hast %s wiederbelebt und dabei ~g~€%s erhalten!',
    ...
    ['respawn_bleedout_fine'] = 'Drücke [E] um für ~g~€%s zu respawnen',
    ['respawn_bleedout_fine_msg'] = 'Du hast ~r~€%s bezahlt, um zu respawnen.',
    ...
    ['mission_canceled']          = 'Mission ~r~canceled',
    ...
    ['not_experienced_enough']    = 'you are not ~r~experienced enough to perform this action.',
    ['gas_can']                   = 'gas Can',
    ...
    ['must_near']                 = 'you must be ~r~near a vehicle to impound it.',
    ['vehicle_success_attached']  = 'vehicle successfully attached',
    ['please_drop_off']           = 'please drop off the vehicle at the garage',
    ['cant_attach_own_tt']        = '~r~you can\'t attach own tow truck',
    ['no_veh_att']                = 'there is no ~r~vehicle to be attached',
    ['not_right_veh']             = 'this is not the right vehicle',
    ['veh_det_succ']              = 'vehicle successfully dettached!',
    ['imp_flatbed']               = '~r~Action impossible! You need a Flatbed to load a vehicle',
    ['objects']                   = 'objects',
    ['roadcone']                  = 'roadcone',
    ['toolbox']                   = 'toolbox',
    ...
    ['wait_five']                 = 'you must ~r~wait 5 mintes',
    ...
    ['not_enough_gas_can']        = 'You do not ~r~have enough gas cans.',
    ['assembling_blowtorch']      = 'Assembling Blowtorch...',
    ['not_enough_repair_tools']   = 'You do not ~r~have enough repair tools.',
    ['assembling_repair_kit']     = 'Assembling Repair Kit...',
    ['not_enough_body_tools']     = 'You do not ~r~have enough body tools.',
    ...
    ['armory_bought'] = 'you bought an %s for ~g~€%s',
    ...
    ['vehicle_unlocked'] = 'Fahrzeug ~g~offen',
    ...
    ['moved_out_sold'] = 'you have sold the property for ~g~€%s',
    ['buy'] = 'buy property for <span style="color:green;">€%s</span>',
    ['buy_for'] = 'you purchased a property for ~g~€%s',
    ['rent'] = 'rent property for <span style="color:green;">€%s</span> / week',
    ['rent_for'] = 'you rented a property for ~g~€%s / week, payment is automatic',
    ...
    ['paid_rent'] = 'you paid your rent at ~g~€%s for %s',
    ['paid_rent_evicted'] = 'you have been ~o~evicted from %s for not affording rent at ~g~€%s',
    ...
    ['you_have']               = 'you have ~g~€%s waiting in money laundering (24h).',
    ['you_have_laundered']     = 'you have ~r~laundered your money: ~g~€%s',
    ...
    ['customer_found'] = 'du hast einen Passagier ~g~gefunden , Fahre in zum Ziel',
    ['client_unconcious'] = 'dein Passagier ist ~r~bewusstlos. Suche nach einem anderen.',
    ['arrive_dest'] = 'du bist an deinem Ziel ~g~angekommen',
    ...
    ['delivered']               = 'the vehicle has been ~g~delivered to the dealer',
    ...
    ['paid_rental']             = 'you have paid ~g~€%s for renting a vehicle with plate %s',
    ['paid_rental_evicted']     = 'you could not afford to pay ~g~€%s for your rented vehicle with plate %s, it has been returned to the dealership',
    ...
    ['vehicle_sold_for']        = 'the %s has been sold for ~g~€%s',
    ...
    ['gived_car'] = 'Fahrzeug %s mit dem Nummernschild %s wurde in ~g~%s\'s Garage gestellt.',
    ...
    ['prompt_wash_paid'] = 'Drücke ~INPUT_CONTEXT~, um dieses Fahrzeug für ~g~€%s zu waschen',
    ...
    ['wash_successful_paid'] = 'Dein Fahrzeug wurde ~g~€%s gewaschen',
    ...
    ['no_threat'] = 'Du musst eine Waffe benutzen, um den Raubüberfall zu starten.',
        ...
        ['gave_account_money'] = 'du gibst ~g~€%s (%s) an %s',
        ['received_account_money'] = 'du empfängst ~g~€%s (%s) von %s',
        ...
        ['threw_account'] = 'du wirfst ~g~€%s %s weg',
        ...
        -- Salary related
        ['received_salary'] = 'du hast dein Gehalt erhalten: ~g~€%s',
        ['received_help'] = 'du hast deine Sozialhilfe erhalten: ~g~€%s',
        ...
        --MONEYWASH
        ['you_have_washed'] 		= 'Du erhälst: ~r~€',
        ['you_have_washed_waiting'] = '~r~Schwarzgeld wird gewaschen in: ~s~Zeit:~b~  ',
        -- ['dirty_money'] 			= ' Schwarzgeld.',
        ['you_have_received'] 		= ' ~s~Gewaschenes Bargeld beträgt: ~g~€',
        ['clean_money'] 			= 'Bargeld',
        -- ['invalid_amount']			= 'Du hast einen ungültigen Betrag eingegeben',
        -- ['press_menu'] 				= 'Drücke ~INPUT_CONTEXT~ um ~r~Schwarzeld ~s~zu ~r~waschen.~s~',
        -- ['no'] 						= 'Nein',
        ...
        -- ['lester'] = '~g~Sie haben Schmuck gestohlen! Bringen Sie jetzt Juwelen zu sich ~r~Lester!',
        ...
        -- ['wash_successful_paid'] = 'Du hast dein Auto gewaschen ~g~$%s~s~',
        ...
        --LEICHEN UNTERSUCHEN
        ['press_e'] = 'Press [E] to check what the person ~r~died~s~ of',
