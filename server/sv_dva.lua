...
CreateThread(function()
    while (true) do
        ...
        TriggerClientEvent("prime_notify", -1, "info", "Carclear", string.format(Config_vehdespawn.timeLeftNotification, Config_vehdespawn.despawnNotificationTimes[1]), 5000)
        for i = 2, #Config_vehdespawn.despawnNotificationTimes, 1 do
            ...
            TriggerClientEvent("prime_notify", -1, "info", "Carclear", string.format(Config_vehdespawn.timeLeftNotification, Config_vehdespawn.despawnNotificationTimes[i]), 5000)
        end
...
RegisterCommand(Config_vehdespawn.despawnCommand, function(source, args, raw)
    if (#args > 0 and tonumber(args[1])) then
        TriggerClientEvent("prime_notify", -1, "info", "Carclear", string.format(Config_vehdespawn.timeLeftNotification, args[1]), 5000)
...
function DeleteAllVehicles()
    TriggerClientEvent("prime_notify", -1, "info", "Carclear", Config_vehdespawn.deleteNotification, 5000)
