...
local txd = CreateRuntimeTxd('Menu_1')
local Header = CreateDui('https://cdn.discordapp.com/attachments/1174010791930900510/1179543202961817790/BANNER2.png', 520, 128)
local TextureHandle = GetDuiHandle(Header)
local Texture = CreateRuntimeTextureFromDuiHandle(txd, 'Menu_2', TextureHandle)
HeaderSprite = 'Menu_1'
HeaderTexture = 'Menu_2'
HeaderTitle = ''
CS_UI = {}
CS_UI.Colours = {}
CS_UI.Colours.R = 0
...
local TextureHandle = GetDuiHandle(Header)
local Texture = CreateRuntimeTextureFromDuiHandle(txd, 'Menu_2', TextureHandle)
local DefaultSprite = 'Menu_1'
local DefaultTexture = 'Menu_2'
...
function RageUI.UpdateHeader(url, width, height)
    cock_txt = CreateRuntimeTxd('Menu_1')
    cock_Header = CreateDui(url, width, height)
    cock_Handle = GetDuiHandle(cock_Header)
    Texture = CreateRuntimeTextureFromDuiHandle(cock_txt, 'Menu_2', cock_Handle)
    DefaultSprite = 'Menu_1'
    DefaultTexture = 'Menu_2'
end
