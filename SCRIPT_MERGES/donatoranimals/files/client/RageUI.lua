--RageUI Settings
Menyo = {}
Menyo.Title = 'LIMITLESS' --Only gets used if you dont use a Custom GIF for the Header
Menyo.HeaderURL = 'https://cdn.discordapp.com/attachments/1112045872910442578/1157643251344474183/peds.png?ex=65195acb&is=6518094b&hm=f10bc6a0e3c82c775872ced8b700d7e0202b92e68d8d488ee7327834945cf9f6&' --.GIF Link or Empty
Menyo.HeaderWidth = 512
Menyo.HeaderHeigth = 128
Menyo.X = 235
Menyo.Y = 90
Menyo.Sounds = {}
...
local HeaderTexture = nil
local HeaderTitle = nil
if not string.find(Menyo.HeaderURL, '.gif') and not string.find(Menyo.HeaderURL, '.png') and not string.find(Menyo.HeaderURL, '.jpg') then
    HeaderSprite = 'commonmenu'
    HeaderTexture = 'interaction_bgd'
    HeaderTitle = Menyo.Title
else
    local txd = CreateRuntimeTxd('Menu')
    local Header = CreateDui(Menyo.HeaderURL, Menyo.HeaderWidth, Menyo.HeaderHeigth)
    local TextureHandle = GetDuiHandle(Header)
    local Texture = CreateRuntimeTextureFromDuiHandle(txd, 'MenuHeader', TextureHandle)
    HeaderSprite = 'Menu'
    HeaderTexture = 'MenuHeader'
    HeaderTitle = ''
end
CS_UI = {}
CS_UI.Colours = {}
        ...
        if CurrentMenu.Sprite ~= nil then
            if CurrentMenu.Sprite.Dictionary ~= nil then
                if CurrentMenu.Sprite.Dictionary == "commonmenu" then
                    Graphics.Sprite(HeaderSprite, HeaderTexture, CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, CurrentMenu.Sprite.Color.R, CurrentMenu.Sprite.Color.G, CurrentMenu.Sprite.Color.B, CurrentMenu.Sprite.Color.A)
                end
            else
...
function RageUI.Subtitle()
    ...
    if (CurrentMenu.Display.Subtitle) then
        ...
        if CurrentMenu.Subtitle ~= "" then
            Graphics.Rectangle(CurrentMenu.X, CurrentMenu.Y + RageUI.ItemOffset, RageUI.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 0, 0, 0, 5)
            ...
            Graphics.Rectangle(RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Description.Bar.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset - 42, RageUI.Settings.Items.Description.Bar.Width + RageUI.CurrentMenu.WidthOffset, 2, CS_UI.Colours.R, CS_UI.Colours.G, CS_UI.Colours.B, CS_UI.Colours.A)
            Graphics.Rectangle(RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Description.Bar.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset - 6, RageUI.Settings.Items.Description.Bar.Width + RageUI.CurrentMenu.WidthOffset, 2, CS_UI.Colours.R, CS_UI.Colours.G, CS_UI.Colours.B, CS_UI.Colours.A)
        end
    end
end
...
function RageUI.Description()
    ...
    if CurrentMenu.Description ~= nil then
        RageUI.ItemsSafeZone(CurrentMenu)
        Graphics.Rectangle(RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Description.Bar.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset - 2, RageUI.Settings.Items.Description.Bar.Width + RageUI.CurrentMenu.WidthOffset, 2, CS_UI.Colours.R, CS_UI.Colours.G, CS_UI.Colours.B, CS_UI.Colours.A)
        Graphics.Rectangle(RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Description.Bar.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 37, RageUI.Settings.Items.Description.Bar.Width + RageUI.CurrentMenu.WidthOffset, 2, CS_UI.Colours.R, CS_UI.Colours.G, CS_UI.Colours.B, CS_UI.Colours.A)
