...
function Helpers.Bounding.DrawEntityBoundingBox(entity, r, g, b, a)
    local box = Helpers.Bounding.GetEntityBoundingBox(entity)
    Helpers.Bounding.DrawBoundingBox(box, r, g, b, a)
end

function Helpers.Bounding.GetEntityBoundingBox(entity)
...
function Helpers.Bounding.DrawBoundingBox(box, r, g, b, a)
    local polyMatrix = Helpers.Bounding.GetBoundingBoxPolyMatrix(box)
    local edgeMatrix = Helpers.Bounding.GetBoundingBoxEdgeMatrix(box)

    Helpers.Bounding.DrawPolyMatrix(polyMatrix, r, g, b, a)
    Helpers.Bounding.DrawEdgeMatrix(edgeMatrix, 255, 255, 255, 255)
end

function Helpers.Bounding.GetBoundingBoxPolyMatrix(box)
    return {
...
function Helpers.Bounding.GetBoundingBoxEdgeMatrix(box)
    return {
        [1] = {[1] = box[1], [2] = box[2]},
        [2] = {[1] = box[2], [2] = box[3]},
        [3] = {[1] = box[3], [2] = box[4]},
...
function Helpers.Bounding.DrawPolyMatrix(polyCollection, r, g, b, a)
...
function Helpers.Bounding.DrawEdgeMatrix(linesCollection, r, g, b, a)
