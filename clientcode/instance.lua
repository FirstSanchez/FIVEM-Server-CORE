...
RegisterServerEvent('lm_instance:ModdenMachtzwarSpassaberistdochnichtCOOLBrudiii')
AddEventHandler('lm_instance:ModdenMachtzwarSpassaberistdochnichtCOOLBrudiii', function()
	...
	if loadedclients[source] == false then
		...
		TriggerClientEvent('lm_instance:ModdenMachtzwarSpassaberistdochnichtCOOLBrudiii', _source, text_program)
