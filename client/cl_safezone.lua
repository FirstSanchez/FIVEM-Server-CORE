		...
		if dist <= safezone.radius then
			if not SafezoneIn then
				...
				if safezone.showNotification then
					TriggerEvent('prime_notify', "info", "Safezone", "Du bist nuni in ener Safezone.", 10000)
				end
				SafezoneIn = true
				SafezoneOut = false
			end
			...
			if not SafezoneOut then
				...
				if safezone.showNotification then
					TriggerEvent('prime_notify', "info", "Safezone", "Du hast die Safezone verlassen.", 10000)
				end
